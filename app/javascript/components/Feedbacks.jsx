...
const FeedbackCard = ({
  ...
  <motion.div
    ...
    className="bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full border border-gray-800"
  >
    <p className="text-gray-500 font-black text-[48px]">"</p>

    <div className="mt-1">
      <p className="text-gray-300 tracking-wider text-[18px]">{testimonial}</p>
...
const Feedbacks = ({ testimonials = [] }) => {
  ...
  return (
    <div className="mt-12 bg-black-100 rounded-[20px] border border-gray-800">
