  ...
  return (
    <section className="relative w-full min-h-[60vh] sm:min-h-[70vh] mx-auto overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-8 sm:px-16 pt-28 sm:pt-32 pb-16 sm:pb-20 flex flex-row items-start gap-6">
          ...
          <div>
            ...
            <motion.div
              ...
              className="mt-4 lg:text-[28px] sm:text-[24px] xs:text-[20px] text-[16px] lg:leading-[40px]"
            >
