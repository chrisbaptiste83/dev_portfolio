...
const Hero = ({ name = 'Christopher Baptiste' }) => {
  ...
  return (
    <section className="relative w-full min-h-[60vh] sm:min-h-[70vh] mx-auto overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 sm:px-16 pt-28 sm:pt-32 pb-16 sm:pb-24 flex flex-col lg:flex-row items-start gap-10">
        {/* Left column */}
        ...
        >
          <div className="hero-card p-6 space-y-5">
            ...
            <div>
              <p className="text-white font-semibold text-lg leading-tight">Full-Stack Developer</p>
              <p className="text-neutral-500 text-sm mt-1">Rails · React · TypeScript</p>
            </div>

            <div className="flex items-center justify-between text-sm text-neutral-500 pt-4 border-t border-white/5">
